...
<body id="home">
  ...
  <nav class="navbar navbar-expand-md navbar-dark bg-dark" style="">
    <div class="container justify-content-center"> <button class="navbar-toggler navbar-toggler-right border-0" type="button" data-toggle="collapse" data-target="#navbar9">
      ...
      <div class="collapse navbar-collapse text-center justify-content-center" id="navbar9">
        <ul class="navbar-nav">
          <li class="nav-item mx-2"> <a class="nav-link" href="src/views/home_login.html">Home</a> </li>
          <li class="nav-item mx-2"> <a class="nav-link" href="#">Perizinan</a> </li>
          <li class="nav-item mx-2"> <a class="nav-link" href="src/views/peminjaman.html">Peminjaman</a> </li>
          <li class="nav-item mx-2"> <a class="nav-link" href="src/views/bantuan_dana.html">Bantuan Dana</a> </li>
          <li class="nav-item mx-2"> <a class="nav-link" href="src/views/tentang_kami.html">Tentang kami</a> </li>
          <li class="nav-item mx-2"> <a class="nav-link" href="src/views/login.html">Logout</a> </li>
        </ul>
      </div>
    </div>
  </nav>
  <div class="py-5 text-white" style="background-image: linear-gradient(rgba(0, 0, 0, 0.75), rgba(0, 0, 0, 0.75)), url(&quot;https://static.pingendo.com/cover-bubble-dark.svg&quot;); background-position: center center, center center; background-size: cover, cover; background-repeat: repeat, repeat;">
    <div class="container">
      <div class="row">
        <div class="col-lg-5 p-0"><img class="img-fluid d-block" src="src/public/pict/P_20150306_173311.jpg"></div>
  ...
  <div class="py-5 text-white" style="background-image: linear-gradient(to bottom, rgba(0, 0, 0, .75), rgba(0, 0, 0, .75)), url(https://static.pingendo.com/cover-bubble-dark.svg);  background-position: center center, center center;  background-size: cover, cover;  background-repeat: repeat, repeat;">
    <div class="container">
      <div class="row">
        <div class="col-lg-5 p-0"><img class="img-fluid d-block" src="src/public/pict/auditorium_centre_large.jpg"></div>
        <div class="p-5 col-lg-7 d-flex flex-column justify-content-center">
  ...
  <div class="py-5 text-white" style="background-image: linear-gradient(to bottom, rgba(0, 0, 0, .75), rgba(0, 0, 0, .75)), url(https://static.pingendo.com/cover-bubble-dark.svg);  background-position: center center, center center;  background-size: cover, cover;  background-repeat: repeat, repeat;">
    <div class="container">
      <div class="row">
        <div class="col-lg-5 p-0"><img class="img-fluid d-block" src="src/public/pict/fdfdfdf.jpg"></div>
